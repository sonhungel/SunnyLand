...
public class CharacterController2D : MonoBehaviour
{
    ...
    //[SerializeField] private float m_ClimbSpeed = 50f;                          // Amount of speed added when the player climb
    ...
    //[SerializeField] private Transform m_LadderCheck;                           // A position marking where to check if player touch ladder
